...
//    public String getCreateStudentAccountTable(){return "CREATE TABLE IF NOT EXISTS studentaccount (id INT AUTO_INCREMENT PRIMARY KEY, schoolid int NOT NULL, name int NOT NULL";}
